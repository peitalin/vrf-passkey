...
const Toggle = ({ checked, onChange, tooltip, label = "", showTooltip = true, className = '', size = 'small', textPosition = 'left', colors }) => {
    ...
    return (jsxRuntime.jsxRuntimeExports.jsxs("div", { className: `${className}`, children: [!showTooltip && (jsxRuntime.jsxRuntimeExports.jsx("style", { children: `
            .toggle-label.no-tooltip::after,
            .toggle-label.no-tooltip::before {
              display: none !important;
            }
          ` })), jsxRuntime.jsxRuntimeExports.jsxs("label", { className: `toggle-label ${!showTooltip || !tooltip ? 'no-tooltip' : ''}`, ...(tooltip && showTooltip && { 'data-tooltip': tooltip }), style: {
                    position: 'relative',
                    cursor: 'pointer',
                    userSelect: 'none',
                    fontWeight: '500',
                    ...
                    ...(isLarge && {
                        ...
                        gap: '8px'
                ...
                }, children: [jsxRuntime.jsxRuntimeExports.jsx("input", { type: "checkbox", checked: checked, onChange: (e) => onChange(e.target.checked), className: "toggle-checkbox", style: {
                            opacity: 0,
                            position: 'absolute',
                            width: 0,
                            height: 0
                        } }), jsxRuntime.jsxRuntimeExports.jsx("span", { style: {
                            position: 'relative',
                        ...
                        }, children: jsxRuntime.jsxRuntimeExports.jsx("span", { style: {
                                position: 'absolute',
                                content: '""',
                            ...
                            } }) }), jsxRuntime.jsxRuntimeExports.jsx("span", { className: "toggle-text", style: {
                            fontWeight: '500',
