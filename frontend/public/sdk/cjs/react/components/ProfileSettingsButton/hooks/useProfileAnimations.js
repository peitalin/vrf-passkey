...
var anime_esm = require('../../../node_modules/.pnpm/animejs@4.0.2/node_modules/animejs/lib/anime.esm.js');
...
const useProfileAnimations = ({ isOpen, refs, openDimensions, closedDimensions, }) => {
    // Store latest dimensions in refs to avoid re-triggering animations
    const dimensionsRef = require$$0.useRef({ openDimensions, closedDimensions });
    ...
    const animationStateRef = require$$0.useRef(null);
    require$$0.useEffect(() => {
        ...
        if (isOpen) {
            ...
            requestAnimationFrame(() => {
                ...
                anime_esm.animate(buttonRef.current, {
                ...
                if (dropdownRef.current) {
                    anime_esm.animate(dropdownRef.current, {
                        opacity: [0, 1],
                        visibility: 'visible',
                ...
                if (menuItems.length > 0) {
                    ...
                    anime_esm.animate(menuItems, {
                        opacity: [0, 1],
                        translateY: [20, 0],
                        scale: [0.8, 1],
                        duration: ANIMATION_CONFIGS.menuItems.in.duration,
                        easing: ANIMATION_CONFIGS.menuItems.in.easing,
                        delay: anime_esm.stagger(ANIMATION_CONFIGS.menuItems.in.staggerDelay, { from: 'first' }),
                    });
                }
            });
        }
            ...
            if (menuItems.length > 0) {
                anime_esm.animate(menuItems, {
                    ...
                    delay: anime_esm.stagger(ANIMATION_CONFIGS.menuItems.out.staggerDelay, { from: 'last' }),
                });
            }
...
exports.useProfileAnimations = useProfileAnimations;
//# sourceMappingURL=useProfileAnimations.js.map
