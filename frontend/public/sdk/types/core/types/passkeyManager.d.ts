...
export interface OperationHooks {
    ...
    afterCall?: (success: boolean, result?: ActionResult | LoginResult | RegistrationResult | Error) => void | Promise<void>;
}
...
export type RegistrationSSEEvent = WebAuthnVerificationSSEEvent | UserReadySSEEvent | AccessKeyAdditionSSEEvent | AccountVerificationSSEEvent | DatabaseStorageSSEEvent | ContractRegistrationSSEEvent | RegistrationCompleteSSEEvent | RegistrationErrorSSEEvent;
...
export type ActionSSEEvent = ActionPreparationSSEEvent | ActionAuthenticationSSEEvent | ActionContractVerificationSSEEvent | ActionTransactionSigningSSEEvent | ActionBroadcastingSSEEvent | ActionCompleteSSEEvent | ActionErrorSSEEvent;
...
export type LoginEvent = LoginPreparationSSEEvent | LoginWebAuthnAssertionSSEEvent | LoginVrfUnlockSSEEvent | LoginCompleteSSEEvent | LoginErrorSSEEvent;
...
export type ActionEvent = {
    type: 'actionStarted';
    data: ActionStartedEvent;
} | {
    type: 'actionProgress';
    data: ActionProgressEvent;
} | {
    type: 'actionCompleted';
    data: ActionCompletedEvent;
} | {
    type: 'actionFailed';
    data: ActionFailedEvent;
};
...
//# sourceMappingURL=passkeyManager.d.ts.map