...
import { PasskeyManager } from '../src/core/PasskeyManager/index.js';
import { useNearRpcProvider } from '../hooks/useNearRpcProvider.js';
...
const PasskeyProvider = ({ children, config: userConfig }) => {
    ...
    return jsxRuntimeExports.jsx(PasskeyContext.Provider, { value: value, children: children });
};
...
export { PasskeyProvider, usePasskeyContext };
