...
import { createAccountTestnetFaucet } from './createAccountTestnetFaucet.js';
...
async function handleRegistration(context, nearAccountId, onEvent, onError, hooks) {
    ...
    try {
        ...
        const accountCreationResult = await createAccountTestnetFaucet(nearAccountId, keyGenResult.publicKey, onEvent);
        ...
        try {
            await webAuthnManager.atomicOperation(async (db) => {
                ...
                await webAuthnManager.storeAuthenticator({
                    ...
                    credentialPublicKey: await webAuthnManager.extractCosePublicKey(bufferEncode(response.attestationObject)),
